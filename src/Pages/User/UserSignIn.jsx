            ...
            <div className="p-3 pt-0 ">
              <form>
                ...
                <div className="mt-4 flex gap-2">
                  <div className="group flex-1 relative rounded-lg border focus-within:border-sky-200 px-3 pb-1.5 pt-2.5 duration-200 focus-within:ring focus-within:ring-sky-300/30">
                    <div className="flex justify-between">
                      <label className="text-xs font-medium text-muted-foreground group-focus-within:text-white text-gray-400">
                        Password
                      </label>
                  ...
                  <div className="flex  border-[3px] border-purple-400 rounded-xl select-none">
