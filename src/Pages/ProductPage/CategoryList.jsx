...
function CategoryList() {
  ...
  <section className=" py-24 px-4 lg:px-16"> 
    <div className="container mx-auto px-[12px] md:px-24 xl:px-12 max-w-[1300px] nanum2">
        <h1 className="text-center dark:text-white text-5xl pb-12">Industries we serve</h1>
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-x-4 gap-y-28 lg:gap-y-16">
            <div className="relative group h-48 flex   flex-col rounded-xl bg-light-gradient bg-clip-border text-gray-700 shadow-md">
                    ...
                    <div className="h-28">
                        <div
                            ...
                            <img src="https://epicpadprinting.com/public/img/indus/Footwear.png"
                                className="w-36 h-36  mt-6 m-auto" alt="Footwear" title="Footwear" loading="lazy"
                                width="200" height="200"/>
                        </div>
                    </div>
                    <div className="p-6   z-10 w-full   ">
                    ...
                    <div className="h-28">
                        <div
                            ...
                            <img src="https://epicpadprinting.com/public/img/indus/Mobile.png"
                                className="w-36 h-36  mt-6 m-auto" alt="Consumer Electronics" title="Consumer Electronics"
                    ...
                    <div className="h-28">
                        <div
                            ...
                            <img src="https://epicpadprinting.com/public/img/indus/Packaging-FMCG.png"
                                className="w-36 h-36  mt-6 m-auto" alt="Packaging / FMCG" title="Packaging / FMCG"
                                loading="lazy" width="200" height="200"/>
                        </div>
                    </div>
                    <div className="p-6   z-10 w-full   ">
                    ...
                    <div className="h-28">
                        <div
                            ...
                            <img src="https://epicpadprinting.com/public/img/indus/Backpacks-and-umbrella.png"
                                className="w-36 h-36  mt-6 m-auto" alt="Backpacks and Umbrella"
                    ...
                    <div className="h-28">
                        <div
                            ...
                            <img src="https://epicpadprinting.com/public/img/indus/Confectionery.png"
                                className="w-36 h-36  mt-6 m-auto" alt="Confectionery" title="Confectionery" loading="lazy"
                                width="200" height="200"/>
                        </div>
                    </div>
                    <div className="p-6   z-10 w-full   ">
                    ...
                    <div className="h-28">
                        <div
                            ...
                            <img src="https://epicpadprinting.com/public/img/indus/Electronics.png"
                                className="w-36 h-36  mt-6 m-auto" alt="Electronics" title="Electronics" loading="lazy"
                                width="200" height="200"/>
                        </div>
                    </div>
                    <div className="p-6   z-10 w-full   ">
                    ...
                    <div className="h-28">
                        <div
                            ...
                            <img src="https://epicpadprinting.com/public/img/indus/Promotional.png"
                                className="w-36 h-36  mt-6 m-auto" alt="Promotional" title="Promotional" loading="lazy"
                                width="200" height="200"/>
                        </div>
                    </div>
                    <div className="p-6   z-10 w-full   ">
                    ...
                    <div className="h-28">
                        <div
                            ...
                            <img src="https://epicpadprinting.com/public/img/indus/Stationery.png"
                                className="w-36 h-36  mt-6 m-auto" alt="Stationery" title="Stationery" loading="lazy"
                                width="200" height="200"/>
                        </div>
                    </div>
                    <div className="p-6   z-10 w-full   ">
                    ...
                    <div className="h-28">
                        <div
                            ...
                            <img src="https://epicpadprinting.com/public/img/indus/Tools.png"
                                className="w-36 h-36  mt-6 m-auto" alt="Tools" title="Tools" loading="lazy" width="200"
                                height="200"/>
                        </div>
                    </div>
                    <div className="p-6   z-10 w-full   ">
